...
// instead of printing just the name of the pizza. For each pizza you should have one line of output
...
let myPizza = ["Vegetarian Pizza", "Cheeze Pizza", "Popperoni Pizza"];
